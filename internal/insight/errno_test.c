...
static void test_insight_set_stream_handler(void** state) {
  (void) state;
  extern insight_stream_handler_t* insight_stream_handler;

  insight_set_stream_handler(&old_stream_handler);
  assert_ptr_equal(insight_stream_handler, &old_stream_handler);

  insight_stream_handler_t* ret = insight_set_stream_handler(&new_stream_handler);
